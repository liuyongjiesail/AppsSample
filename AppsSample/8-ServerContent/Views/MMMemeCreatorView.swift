...
struct MMMemeCreatorView: View {
    @EnvironmentObject var fetcher: MMPandaCollectionFetcher
    ...
    var body: some View {
        VStack(alignment: .center) {
            Spacer()
            MMLoadableImageView(imageMetadata: fetcher.currentPanda)
...
struct MMMemeCreatorView_Previews: PreviewProvider {
    static var previews: some View {
        MMMemeCreatorView().environmentObject(MMPandaCollectionFetcher())
    }
}
